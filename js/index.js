...
function update(swiper){
        console.log(swiper);
        swiper.activeIndex === 5  ? setTimeout(function(){S.UI.simulate('小仙女|我想对你说|最好的样子就是||在一起♡');},3000) : '';
}       
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      //setTimeout(function(){S.UI.simulate('小仙女|我想对你说|最好的样子就是...||♡');},3000)
      //S.UI.simulate('小仙女|我想对你说|最好的样子就是...||♡');
    }
